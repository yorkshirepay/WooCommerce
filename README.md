YorkshirePay Woocommerce Plugin
==============

This module enables the use of https://gateway.yorkshirepayments.com payment gateway using the Woocommerce project http://www.woothemes.com.
...
This module enables the woocommerce customers to pay for their items using the YorkshirePay hosted form or direct payment gateway.

What does it do?
----------------
Presents the option to pay with credit card or debit card via the YorkshirePay payment gateway.
...
4. Find YorkshirePay in the Payment Gateways section 
...
a gateway URL i.e. https://gateway.yorkshirepayments.com to be entered in the plugin's settings.
